...
let keyBell = document.querySelector(".keyBell");
let dropLink = document.querySelectorAll(".drop-link");
let dd0 = document.querySelector(".drop-link0");
let dd1 = document.querySelector(".drop-link1");
let dd2 = document.querySelector(".drop-link2");
...
let timer;
let enable = true;
let chimes = new Audio('/theApp/chimes.mp3');
...
keyBell.addEventListener("click", function(){stopSound()}, false);
